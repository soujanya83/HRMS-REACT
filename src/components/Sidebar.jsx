    ...
    return (
        <>
            ...
            <div 
                ...
                md:translate-x-0`}
            >
                {/* This wrapper is for the main content and allows the collapse button to be positioned correctly */}
                <div className="relative h-full flex flex-col">
                    ...
                    {/* THE FIX: Added the `scrollbar-hide` class to this container */}
