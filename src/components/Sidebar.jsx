...
const Sidebar = ({
  ...
  const getNavLinkClass = ({ isActive }) => {
    ...
    return isActive
      ? `${linkStyle} bg-teal-700 text-white font-semibold shadow-lg ${collapsedClass}`
      : `${linkStyle} text-gray-300 font-semibold hover:bg-teal-800 hover:text-white ${collapsedClass}`;
  };
      ...
      if (child.path === "/dashboard/employees") {
        ...
        return `flex items-center w-full px-4 py-2.5 my-1 rounded-lg text-sm ${
          isExactMatch
            ...
            : "text-gray-400 hover:bg-teal-800 hover:text-white"
        }`;
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-y-0 left-0 bg-teal-800 border-r border-teal-700 flex flex-col justify-between z-30 transition-all duration-300 ease-in-out
        ...
        <div className="relative h-full flex flex-col">
          <div className="absolute top-[104px] -right-4 -translate-y-1/2 hidden md:block z-10">
            <button
              ...
              className="bg-teal-600 text-white p-1.5 rounded-full shadow-lg hover:bg-teal-500 transition-colors"
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            <div className="border-b border-teal-700 h-[104px] flex-shrink-0">
                    ...
                    {!link.children ? (
                      ...
                      <>
                        <button
                          ...
                          className={`flex items-center w-full px-4 h-14 rounded-lg text-base text-gray-300 font-semibold hover:bg-teal-700 hover:text-white transition-colors duration-200 text-left ${
          ...
          <div className="p-4 border-t border-teal-700 flex-shrink-0">
            <button
              ...
              className={`flex items-center w-full px-4 h-12 rounded-lg text-base font-semibold hover:bg-teal-700 hover:text-white text-gray-300 duration-200 ${
