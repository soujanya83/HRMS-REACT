  ...
  return (
    <div ref={containerRef} className="relative w-full">
      ...
      <button
        ...
        disabled={disabled}
        className={`w-full border border-gray-300 px-3 py-2 rounded-lg text-left bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 flex items-center justify-between transition-all ${
          !value || value === 'all' ? 'text-gray-500' : 'text-gray-900 border-blue-200'
            ...
            {allowAll && (
              <div
                ...
                className={`px-3 py-2 cursor-pointer text-sm hover:bg-blue-50 transition-colors ${
                  value === 'all' ? 'bg-blue-50 text-blue-700 font-semibold' : 'text-gray-700'
                }`}
              >
                {placeholder}
              </div>
              ...
              employees.map((emp) => {
                ...
                return (
                  <div
                    ...
                    className={`px-3 py-2.5 cursor-pointer text-sm hover:bg-blue-50 transition-all flex items-center justify-between border-b border-gray-50 last:border-0 ${
                  ...
                  >
                    <div className="flex flex-col truncate">
                      ...
                      {emp.employee_id_number && (
                        <span className="text-[10px] text-gray-400">ID: {emp.employee_id_number}</span>
                      )}
                    </div>
