    ...
    setTimeout(() => {
      setOvertimeRequests([
        ...
        },
        {
          ...
          end_time: '20:00',
          hours: 4,
          reason: 'Design sprint completion',
          ...
          rejection_reason: 'Overtime not pre-approved for this project',
          notes: 'Completed UI designs for new features'
        }
      ]);
      setLoading(false);
    }, 1500);
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg border-l-4 border-red-500">
            <div className="flex items-center justify-between">
              ...
              <FaDollarSign className="text-red-500 text-xl" />
            </div>
          </div>
        </div>
        ...
        <div className="overflow-x-auto bg-white shadow-lg rounded-lg">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-bold text-gray-600 uppercase tracking-wider">Hours & Rate</th>
                <th className="px-6 py-3 text-left text-xs font-bold text-gray-600 uppercase tracking-wider">Project & Reason</th>
                ...
                <tr key={request.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="text-sm">
                      ...
                      <div className="text-sm text-gray-700 mt-1 max-w-xs">
                        {request.reason}
                      </div>
                      {request.notes && (
          ...
          {filteredRequests.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-2">No Overtime Requests</h3>
              <p className="text-gray-600">No overtime requests match the current filters.</p>
            </div>
          )}
        </div>
