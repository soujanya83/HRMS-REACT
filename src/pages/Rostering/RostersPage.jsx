...
const RostersPage = () => {
  ...
  const getShiftsForDate = (employeeId, date) => {
    ...
    return shifts.filter(
      (shift) => shift.employee_id === employeeId && shift.date === dateString
    );
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            View and manage employee schedules by week or month
          </p>
        </div>
                ...
                <p className="text-2xl font-bold text-gray-800">
                  {
                    shifts.filter((s) => {
                      ...
                      return (
                        shiftDate >= weekDates[0] && shiftDate <= weekDates[6]
                      );
                    }).length
                  }
                </p>
                  ...
                  return (
                    <div key={day} className="p-2 border-l min-h-20">
                      {dayShifts.map((shift) => (
                        <div
                          key={shift.id}
                          className={`p-2 mb-1 rounded border text-xs ${getShiftColor(
                            shift.shift_type
                          )}`}
                        >
                        ...
                        {shifts
                          ...
                          .map((shift) => {
                            ...
                            return (
                              <div
                                key={shift.id}
                                className={`p-1 rounded text-xs ${getShiftColor(
                                  shift.shift_type
                                )}`}
                              >
