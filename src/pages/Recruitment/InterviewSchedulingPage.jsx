          ...
          <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 mb-6">
            ...
            <div className="flex items-center gap-3 self-start sm:self-center">
              <button
                ...
                className={`inline-flex items-center gap-2 justify-center px-4 py-2 border text-sm font-medium rounded-md shadow-sm ${filterDate
                      ...
                      <div key={interview.id} className="flex items-start gap-4 p-3 bg-gray-50 rounded-lg hover:bg-gray-100">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            <span className={`px-2 py-1 text-xs rounded-full ${statusOptions.find(s => s.value === interview.status)?.color || 'bg-gray-100 text-gray-800'
                              }`}>
                        ...
                        <tr key={interview.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <select
                              ...
                              className={`text-xs font-semibold rounded-full px-3 py-1 border-0 ${statusOptions.find(s => s.value === interview.status)?.color || 'bg-gray-100 text-gray-800'
