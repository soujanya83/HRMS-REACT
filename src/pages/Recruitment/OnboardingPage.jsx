    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-8">
            {activeTab === "dashboard" && <OnboardingDashboard backgroundColor={backgroundColor} />}
            {activeTab === "templates" && <TemplateManager backgroundColor={backgroundColor} />}
          </div>
        </div>
      </div>
    </>
...
// Dashboard Component
const OnboardingDashboard = ({ backgroundColor }) => {
...
const TemplateManager = ({ backgroundColor }) => {
  const [templates, setTemplates] = useState([]);
