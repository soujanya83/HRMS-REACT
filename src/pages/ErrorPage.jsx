...
const ErrorPage = () => {
    // This hook captures the error for logging or display
    const error = useRouteError();
    console.error(error); // Logs the full error to the console for you to debug
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4 text-center">
            ...
            {/* This part is helpful for you during development */}
