...
const GoalSetting = () => {
  ...
  const filteredGoals = goals.filter((goal) => {
    ...
    const matchesDepartment =
      filters.department === "all" || goal.department === filters.department;
    const matchesSearch =
      filters.search === "" ||
  ...
  const getCompactValue = (value, unit) => {
    if (unit === "INR") {
      return formatCurrency(value);
    }
      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="mb-4">
          ...
          <p className="text-xs text-gray-600">
            Set and track organizational, team, and individual goals
          </p>
        </div>
                    ...
                    >
                      ...
                      <td className="px-3 py-2 whitespace-nowrap">
                        <div className="font-semibold text-gray-900 text-[10px]">
                          Target:{" "}
                          {getCompactValue(goal.target_value, goal.unit)}{" "}
                          {goal.unit !== "INR" ? goal.unit : ""}
                        </div>
                        <div className="text-green-600 text-[10px]">
                          Current:{" "}
                          {getCompactValue(goal.current_value, goal.unit)}{" "}
                          {goal.unit !== "INR" ? goal.unit : ""}
                        </div>
                      ...
                      <td className="px-3 py-2 whitespace-nowrap">
                        <div className="space-y-1">
                          ...
                          <span
                            className={`px-1.5 py-0.5 inline-flex text-[10px] font-semibold rounded-full ${getPriorityColor(
                              goal.priority
                            )}`}
                          >
                            {goal.priority}
          ...
          <div className="mt-3 bg-gray-50 px-3 py-2 border-t border-gray-200 rounded text-xs">
            <div className="flex justify-between items-center text-gray-600">
              ...
              <div className="font-semibold">
                Overall Progress:{" "}
                {Math.round(
                  filteredGoals.reduce((sum, g) => sum + g.progress, 0) /
